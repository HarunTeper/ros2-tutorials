#include "tutorial_05_parameters/basic_publisher.hpp"

BasicPublisher::BasicPublisher() : rclcpp::Node("basic_publisher_node")
{
  this->declare_parameter<std::string>("message_string", "TestString");
...
void BasicPublisher::timer_callback()
{
  ...
  msg.strings.push_back(this->get_parameter("message_string").as_string());
